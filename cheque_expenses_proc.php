...
// $company = $_SESSION['sess_company'];
 ...
 <h3 class="box-title" style="color: green; font-weight: bold">Expenses Report(Cheque)</h3>
<div class="row"> 
                           <div class='col-xs-4'>
                                               ...
                                               $total_cash = 0; 
                                                ...
                                                $result18 = mysqli_query($con, $sql18);
                                                    while ($arraySomething18 = mysqli_fetch_array($result18)) {
                                                     ...
                                                     echo "<tr><td colspan='5'> TOTAL CHEQUE EXPENSES</td><td align='right'><b> ".number_format($total_cash,2)."</b></td>";
