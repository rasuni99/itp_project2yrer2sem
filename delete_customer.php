                                ...
                                <form action = "delete_customer.php" class="form-horizontal" method="POST"  enctype="multipart/form-data" name="form" id="form">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p>This will lead to remove the customer after your confirmation. All transactions, combined with this customer will be removed and system won't be able to roll-back these transactions in future.</p>
                                        </div>
                                        <div class="modal-footer">
                                           <button type="button" class="btn btn-outline pull-left"  onClick="parent.location = 'customer_register.php'">Cancel</button>
...
if (isset($_POST['delete'])) {
    ...
    if (mysqli_query($con, $sql)) {
        $sql11 ="INSERT INTO user_activity (user,activity) VALUES ('$user','CUSTOMER REMOVED ID :$id ')";
