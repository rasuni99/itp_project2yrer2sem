...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h1>
        Cancel Return Note
         <small>Enter  Return Order no to cancel the Return Note. Ex :<?php echo $code_returns; ?>100023</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Cancel Return Note</li>
      </ol>
    </section>
    ...
    <section class="content">
     ...
     <div class="box box-primary">
        ...
        <form name="myForm" id ="myform" action="remove_return_note_proc.php" 
                 method="GET" >
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" autocomplete="off" name="return_no" class="form-control pull-right" >
                </div>  
