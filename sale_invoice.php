        ...
        <script>
            ...
            $(document).ready(function(){
                    ...
                    $('#insert_form').on('submit', function(event){
                     ...
                     if(error == '')
                     {
                     if (confirm(" Are you sure you want to generate the order note? "))
  {
                      $.ajax({
           ...
           <div class="row">
                ...
                <div class="form-group">
                    ...
                    <option value=""> SELECT DRIVER </OPTION>
                          ...
                          <?php
                            ...
                            $sql1 = mysqli_query($con1,"SELECT id,first_name,last_name FROM employee WHERE  stat='1' AND resigned='0' AND company='$company' AND possition= 'DRIVER'");
                            while ($row = mysqli_fetch_array($sql1)) {
                                    ?>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2" style="width: 100%;" name="porter" id="porter" >
                    <option value=""> SELECT SALES REP </OPTION>

                          <?php
                            $con1 = mysqli_connect("localhost","root","","shanaz_payroll");
                            $sql1 = mysqli_query($con1,"SELECT id,first_name,last_name FROM employee WHERE  stat='1' AND resigned='0' AND company='$company' AND possition='PORTER'");
                            while ($row = mysqli_fetch_array($sql1)) {
                                    ?>
                                    <option value=" <?php echo $row['id'] ?> "> <?php echo $row['first_name']." ".$row['last_name'] ?> </option>;
                            <?php }
            ...
            <div class="form-group">
                ...
                <option value=""> SELECT VEHICLE </OPTION>
                      ...
                      <?php
                        $sql1 = mysqli_query($con,"SELECT id,vehicle_no FROM vehicles WHERE  stat='1' AND company='$company'");
                        while ($row = mysqli_fetch_array($sql1)) {
                                ?>
    ...
    <div class="table-repsonsive">
     ...
     <table class="table table-bordered" id="item_table">
      <tr>
       ...
       <div class='row'>
            <div class="col-md-6">
            <button type="submit" id="add_payment" class="btn btn-success" >Generate Order</button>       												
       </div>
