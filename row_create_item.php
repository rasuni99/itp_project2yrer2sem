...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
         ...
         <?php
         $sql7 = "SELECT id FROM row_item WHERE company='$company' AND stat = '1' ";
            ...
            <div class="col-md-12">
             ...
             <div class="form-group">
                ...
                <option value=""> SELECT CATEGORY 01 </OPTION>
                      <?php
                                              $sql1 = mysqli_query($con,"SELECT id,name FROM row_category_one WHERE stat='1' AND company='$company' ORDER BY name ASC");
            ...
            <div class="col-md-12">
             <div class="form-group">
                ...
                <option value=""> SELECT CATEGORY 02 </OPTION>
                      <?php
                                              $sql11 = mysqli_query($con,"SELECT id,name FROM row_category_two WHERE stat='1' AND company='$company' ORDER BY name ASC");
            ...
            <div class="col-md-12">
             <div class="form-group">
                ...
                <option value=""> SELECT CATEGORY 03 </OPTION>
                      <?php
                                              $sql12 = mysqli_query($con,"SELECT id,name FROM row_category_three WHERE stat='1' AND company='$company' ORDER BY name ASC");
            ...
            <div class="col-md-12">
             <div class="form-group">
                ...
                <option value=""> SELECT CATEGORY 04 </OPTION>
                      <?php
                                              $sql14 = mysqli_query($con,"SELECT id,name FROM row_category_four WHERE stat='1' AND company='$company' ORDER BY name ASC");
             ...
             <div class="col-md-12"> 
                 ...
                 <div class="form-group">
                <label for="exampleInputPassword1">Re-Order Level</label>
                <input type="text" name="reorderlevel" class="form-control" id="reorderlevel" placeholder="Enter Re-Order Level">
              </div>
             </div> 
                                    ...
                                    <div class="box-body">
                                        <table id="example1" class="table table-bordered table-striped">
                                            <thead>
                                                ...
                                                <?php
                                                echo "<tr><th><center> Item Name </center></th><th><center> Stock-Stores </center></th>
                                        <th><center> Actions</center></th>
					</tr></tfoot></thead><tbody>";
                                           
                                              //  $total_stock = 0;
                                             //   $cat1 = $cat2 = $cat3 = $cat4 = 0;
                                                $sql78 = "SELECT id,cat1,cat2,cat3,cat4,reorder_level,stock_stores FROM row_item WHERE stat = '1' AND company='$company' ORDER BY cat1,cat2 ASC";
                                                $result78 = mysqli_query($con, $sql78);
                                                    while ($arraySomething78 = mysqli_fetch_array($result78)) {
                                                        ...
                                                        $reorder_level = $arraySomething78['reorder_level'];
                                                        $stock_stores = $arraySomething78['stock_stores'];
                                                         ...
                                                         echo "<tr><td align='left'>".$cat1_name." ".$cat2_name." ".$cat3_name." ".$cat4_name." </td> <td align='center'> ".$stock_stores."  </td>";
                                                                  echo "<td align='center'><a type='button' title='Click to Cancel the Item' class='btn btn-default btn-xs confirm_action' href='row_delete_item.php?id=".$id."'>
    ...
    <script>
        $(function () {
            ...
            $('#example1').DataTable({
                ...
                'dom': 'Bfrtip',
    'buttons': [
       { extend: 'excel', text: 'Export to Excel',messageTop: 'Student Filter Information',title:'Queensford College - Certificate IV' ,exportOptions: { columns: [ 0, 1,] }},
