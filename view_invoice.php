...
if (isset($_GET['id'])) {
    ...
    $sql1 = "SELECT id,invoice_real_no,net_amount,type,invoice_type,tax_percentage_id,return_amount,customer_id,date FROM invoice_real WHERE id='$invoice_id'";
    $result1 = mysqli_query($con, $sql1);
    while ($arraySomething1 = mysqli_fetch_array($result1)) {
...
//                            $item = $arraySomething1['item_id'];
    ...
    $net_total = 0;
    $vat_amount_total = $nbt_amount_total = 0;
    $item_discount_all = 0;
    ...
    $sql = "SELECT item_id, item_name, description, quantity, unit_price,discount_per_item, min_sale_price, cash_price, credit_price FROM invoice_items_real WHERE invoice_id='$invoice_id'";
    $result = mysqli_query($con, $sql);
    while ($arraySomething1 = mysqli_fetch_array($result)) {
        $item = $arraySomething1['item_id'];
