    ...
    <head>
        ...
        $(document).ready(function () {
            ...
            $('#insert_form').on('submit', function (event) {
                ...
                if (error == '')
                {
                    if (confirm(" Are you sure you want to generate the quotation? "))
                    {
                        $.ajax({
                            url: "quotation_proc.php",
                            method: "POST",
                            data: form_data,
                                                            ...
                                                            <form method="POST" id="insert_form" name="myform" >   
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <label for="exampleInputPassword1">Customer Name <font color='red'> *</font></label>
                                                                        <input type="text" autocomplete="off" name="customer" class="form-control" id="customer" placeholder="Enter Customer's Name " >
                                                                    </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-8">
                                                                         ...
                                                                         <div class="form-group">
                                                                        <label for="exampleInputPassword1">Customer Address <font color='red'> *</font></label>
                                                                        <input type="text" autocomplete="off" name="address" class="form-control" id="customer" placeholder="Enter Customer's Name " >
                                                                    </div>
                                                                ...
                                                                <div class='row'>
                                                                   ...
                                                                   <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            <label>Quotation Date <font color='red'> *</font></label>

                                                                            <div class="input-group date">
                                                                                <div class="input-group-addon">
                                                                                    <i class="fa fa-calendar"></i>
                                                                                </div>
                                                                                <input type="text" data-date-format='yyyy-mm-dd' autocomplete="off" name="quotedate" class="form-control pull-right" id="datepicker1" required="">
                                                                            </div>  
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="input-group date">
                                                                                ...
                                                                                <input type="text" data-date-format='yyyy-mm-dd' autocomplete="off" name="expiredate" class="form-control pull-right" id="datepicker2" >
                                                                            </div>  
                                                                    ...
                                                                    <div class="col-md-3">
                                                                       <div class="form-group">
                                                                        <label for="exampleInputPassword1">P.O No <font color='red'> *</font></label>
                                                                        <input type="text" autocomplete="off" name="pono" class="form-control" id="pono" placeholder="Enter Customer's PO No " >
                                                                    </div>
                                                                    </div>
                                                                ...
                                                                <div class='row'>
                                                                    <div class="col-md-6">
                                                                        <button type="submit" id="add_payment" class="btn btn-success" >Generate Quotation</button>       												
                                                                    </div>
