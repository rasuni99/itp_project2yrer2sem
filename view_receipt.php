...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h1>
        View Receipt
         <small>Enter Invoice no to view the receipts :<?php echo  $code_invoice_real ;?>100023</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">View Receipts by Invoice NO</li>
      </ol>
    </section>
    ...
    <section class="content">
     ...
     <div class="box box-primary">
        ...
        <form name="myForm"  id ="myform" action="view_receipt.php" 
                 method="POST" >
