...
<script>
         function submitForm() {
          ...
          $.ajax({
              url: "add_bank_account_supplier_proc.php",
              type: "POST",
              data: form_data,
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                 ...
                 method="POST" enctype="multipart/form-datam" onsubmit="return submitForm();">
                                    <div class="box-body">
                                       <input type="hidden" name="acctype" value="SUPPLIER">
                                        
                                          <div class="form-group">
                                            <label>Account owner</label>
                                            <select class="form-control select2" style="width: 100%;" name="accowner" id="customer1" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" autocomplete="off" name="accname" class="form-control" id="accno" placeholder="Enter the Account Owner Name" required>
                                        </div>
                                      <div class="form-group">
                                        <label>Bank</label>
...
//                    }
                    ...
                    <div class="col-md-9">
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="box box-primary">
                                    <div class="box-header with-border">
                                        <h3 class="box-title"><strong>All Bank Accounts </strong></h3>
                                    </div>
                                    <!-- /.box-header -->
                                    <div class="box-body">
                                        <table id="example1" class="table table-bordered table-striped">
                                            <thead>
                                                ...
                                                <?php
                                                echo "<tr><th><center> Owner <center></th> <th><center> Account Name <center></th> 
					...
					<th><center> Account No <center></th>
                                        ...
                                        <th><center>Actions<center></th>
                                                ...
                                                $sql = "SELECT id,owner,acc_name,bank,account_no FROM bank_accounts WHERE type='SUPPLIER' AND company='$company' AND stat = '1' ORDER BY bank ASC";
                                                $result = mysqli_query($con, $sql);
                                                    while ($arraySomething1 = mysqli_fetch_array($result)) {
                                                        $id = $arraySomething1['id'];
                                                        $bankid = $arraySomething1['bank'];
                                                        $accountno = $arraySomething1['account_no'];
                                                        $owner = $arraySomething1['owner'];
                                                        $accname = $arraySomething1['acc_name'];
                                                     
                                                             $sql7 = "SELECT company_name FROM supplier WHERE id='$owner'";
                                                              $result7 = mysqli_query($con, $sql7);
                                                             while ($arraySomething7 = mysqli_fetch_array($result7)) {
                                                          $fullanmeowner = $arraySomething7['company_name'];
                                                             ...
                                                             $result1 = mysqli_query($con, $sql1) ;
                                                                ...
                                                                while ($arraySomething11 = mysqli_fetch_array($result1)) {        
                                                                  $bank = $arraySomething11['name'];
                                                                                ...
                                                                                echo "<tr> <td> &nbsp" . $fullanmeowner . " </td><td> &nbsp" . $accname . " </td>
                                                                <td> &nbsp" . strtoupper($bank) . " </td>
                                                                <td> &nbsp" . $accountno . " </td>
                                                                
                                                                 <td align='center'><a type='button'  class='btn btn-default btn-xs confirm_action' href='delete_bankaccount_supplier.php?account_id=".$id. "&bank=" . $bank."'>
