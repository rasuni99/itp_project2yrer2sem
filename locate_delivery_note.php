...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h1>
        Delivery Order Viewer
         <small>Enter  Delivery Order no to view the previous  delivery order. Ex :<?php echo $code_invoice; ?>100023</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Delivery Order by Delivery Order No</li>
      </ol>
    </section>
    ...
    <section class="content">
     ...
     <div class="box box-primary">
        ...
        <!-- /.box-header -->
          ...
          <form name="myForm" target='_blank' id ="myform" action="locate_delivery_proc.php" 
                 method="POST" >
