  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Enter Supplier</li>
      </ol>
    </section>
    ...
    <section class="content">
     ...
     <div class="box box-primary">
       ...
       <div class="box-header with-border">
           <h3 class="box-title" style="color: green; font-weight: bold">Enter Supplier Details</h3>
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-6">
                ...
                <input type="text" autocomplete="off" name="companyname" class="form-control" id="companyname" placeholder="Enter Supplier Name" required>
              </div>
              <div id="txtHint"></div>
              <div class="form-group">
                <label for="exampleInputPassword1">Supplier Phone</label>
                <input type="text" autocomplete="off" name="phone" class="form-control" id="phone" pattern="[0-9]{10}" title="Invalid Format.Contact No consists of 10 Digits" placeholder="Enter Supplier Phone No">
              </div>
              <div class="form-group">
                 <div class="form-group">
                <label for="exampleInputPassword1">Supplier Address</label>
                <input type="text" autocomplete="off" name="address" class="form-control" id="address" placeholder="Enter Supplier's Address">
              </div>
              </div>
               <div class="form-group">
                <label for="exampleInputPassword1">Supplier Fax</label>
                <input type="text" autocomplete="off" name="fax" class="form-control" id="fax" pattern="[0-9]{10}" title="Invalid Format.Contact No consists of 10 Digits" placeholder="Enter Supplier Fax No">
              </div>
               <div class="form-group">
                <label for="exampleInputPassword1">Supplier Email</label>
                <input type="email" autocomplete="off" name="email" class="form-control" id="email" placeholder="Enter Supplier's Email">
              </div>
            ...
            <div class="col-md-6">
                ...
                <input type="text" autocomplete="off" name="br" onchange="supplier_check(this.value);" class="form-control" id="br" placeholder="Enter Supplier's BR Number">
              </div>
              </div></div>
                ...
                <input type="text" autocomplete="off" name="vat"  class="form-control" id="vat" placeholder="Enter Suppliers's VAT Number">
              </div>
              </div></div>
        ...
        <button type="submit" id="submit" class="btn btn-success">Submit</button>
         ...
         <div class="row">
                           <div class='col-xs-12'>
                                <div class="box box-primary">
                                    <div class="box-header with-border">
           <h3 class="box-title" style="color: green; font-weight: bold">Registered Suppliers</h3>
          <div class="box-tools pull-right">
          </div>
         </div>
                                    <!-- /.box-header -->
					...
					<th><center> Actions</center></th>
                                                ...
                                                $sql = "SELECT id,company_name,company_address,company_phone,company_fax,salutation,person,person_mobile FROM supplier WHERE company='$company' AND stat = '1' ORDER BY company_name ASC";
                                                        ...
                                                        $id1 = $id + 100000;  
                                                         echo "<tr><td> <center>S" . $id1 . " </center></td> <td> &nbsp" .  $company_name1 . " </td><td> &nbsp" . $company_address1. " </td><td>" . $company_phone1 . "</td><td> <center>" . $fax1 . "</center> </td>
                                                                <td> &nbsp" . $salutation1." ". $person1 . " </td><td> &nbsp" . $person_mobile1 . " </td>";
                                                                   ...
                                                                   echo "<td align='center'><a type='button' title='Click to edit the Supplier Details' class='btn btn-default btn-xs confirm_action' href='edit_supplier.php?id=".$id."'>
																 <span class='glyphicon glyphicon-pencil' aria-hidden='true'></span> </a>
                                                                                                                                 <a type='button' title='Click to remove the Supplier' class='btn btn-default btn-xs confirm_action' href='delete_supplier.php?id=".$id."'>
