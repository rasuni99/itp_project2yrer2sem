                ...
                <div class="example-modal">
                        <div class="modal modal-warning">
                            <div class="modal-dialog">
                                <form action = "delete_bankaccount_supplier.php" class="form-horizontal" method="POST"  enctype="multipart/form-data" name="form" id="form">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                           <button type="button" class="btn btn-outline pull-left"  onClick="parent.location = 'add_bank_account_supplier.php'">Cancel</button>
...
if (isset($_POST['delete'])) {
    ...
    if (mysqli_query($con, $sql)) {
        ...
        echo "<script>window.location = 'add_bank_account_supplier.php?msg=BANK ACCOUNT HAS BEEN REMOVED ! ';</script>";
        
    }
    else{
        echo "<script>window.location = 'add_bank_account_supplier.php?msge=REMOVING BANK ACCOUNT FAILED ! CONTACT ADMINISTRATOR ';</script>";
    }
}
