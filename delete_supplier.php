                                ...
                                <form action = "delete_supplier.php" class="form-horizontal" method="POST"  enctype="multipart/form-data" name="form" id="form">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                           <button type="button" class="btn btn-outline pull-left"  onClick="parent.location = 'supplier_register.php'">Cancel</button>
...
if (isset($_POST['delete'])) {
    ...
    $sql = "UPDATE supplier SET stat='0' WHERE id='$id' ";
