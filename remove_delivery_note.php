  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <h1>
        Cancel Delivery Note
         <small>Enter  Delivery Order no to cancel the  delivery order. Ex :<?php echo $code_invoice; ?>100023</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
     ...
     <div class="box box-primary">
        ...
        <form name="myForm" id ="myform" action="remove_delivery_order_proc.php" 
                 method="GET" >
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" autocomplete="off" name="delivery_no" class="form-control pull-right" >
                </div>  
