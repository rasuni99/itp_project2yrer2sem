    ...
    <section class="content-header">
      ...
      <h1>
        Sales Invoice Viewer
         <small>Enter Invoice no to view the previous invoices. Ex :<?php echo  $code_invoice_real;?>100023</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Sale Invoices by Invoice NO</li>
      </ol>
    </section>
    ...
    <section class="content">
     ...
     <div class="box box-primary">
        ...
        <!-- /.box-header -->
          ...
          <form name="myForm" target='_blank' id ="myform" action="locate_invoice_proc.php" 
                 method="POST" >
