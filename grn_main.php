...
{ 
 ...
 $output = '';
 $query = "SELECT id,cat1,cat2,cat3,cat4 FROM row_item WHERE stat='1' AND company='$company' ORDER BY cat1 ASC";
 ...
 foreach($result as $arraySomething1)
 {
    ...
    $cat4 = $arraySomething1['cat4'];
            ...
            $query1 = "SELECT name FROM row_category_one WHERE id='$cat1'";
            ...
            $query1 = "SELECT name FROM row_category_two WHERE id='$cat2'";
            $statement1 = $connect->prepare($query1);
            $statement1->execute();
            $result1 = $statement1->fetchAll();
            foreach($result1 as $arraySomething11)
            ...
            $query1 = "SELECT name FROM row_category_three WHERE id='$cat3'";
            $statement1 = $connect->prepare($query1);
            $statement1->execute();
            $result1 = $statement1->fetchAll();
            foreach($result1 as $arraySomething11)
            ...
            $query1 = "SELECT name FROM row_category_four WHERE id='$cat4'";
            $statement1 = $connect->prepare($query1);
            $statement1->execute();
            $result1 = $statement1->fetchAll();
            foreach($result1 as $arraySomething11)
...
function item_status(str) {
  ...
  xmlhttp.open("GET","ajax_grn_item_status.php?item="+str,true);
  xmlhttp.send();
};
        ...
        <script>
            ...
            $(document).ready(function(){
                    ...
                    var html = '';
                     ...
                     html += '<td><input autocomplete="off"type="text" style="text-align:center;" style="width: 100px" name="quantity[]" id="quantity'+count+'" class="form-control item_quantity" required/></td>';
                     html += '<td><input autocomplete="off"type="text" style="text-align:right;" style="width: 100px" name="unit_price[]" id="unit_price'+count+'"  class="form-control item_quantity" required/></td>';
                     html += '<td><input autocomplete="off" type="text" style="text-align:right;" style="width: 100px" name="total_price[]" id="total_price'+count+'" class="form-control item_quantity" required/></td>';
                    ...
                    $('#insert_form').on('submit', function(event){
                     ...
                     if(error == '')
                     {
                     if (confirm(" Are you sure you want to generate the GRN ? "))
  {
                      $.ajax({
                       url:"grn_main_proc.php",
                       method:"POST",
                       data:form_data,
...
//                           $('#br').val("");
                           ...
                           if(data.includes("Error1")){
                                MessageManager.show("<div class='callout callout-success'><center>GRN GENERATED SUCCESSFULLY !</center></div>");
                                MessageManager1.show("<div class='callout callout-success'><center>GRN GENERATED SUCCESSFULLY !</center></div>");
                           }
                           else if(data.includes("Error2")){
                                MessageManager.show("<div class='callout callout-danger'><center>FAILED : GRN GRNERATING FAILED. CONTACT ADMINISTRATOR !</center></div>");
                                MessageManager1.show("<div class='callout callout-danger'><center>FAILED : GRN GRNERATING FAILED. CONTACT ADMINISTRATOR !</center></div>");
                            }
                            else if(data.includes("Error3")){
                                 MessageManager.show("<div class='callout callout-danger'><center>FAILED : GRN TOTAL PRICE NOT MATCHING WITH ITEMS TOTAL !</center></div>");
                                MessageManager1.show("<div class='callout callout-danger'><center>FAILED : GRN TOTAL PRICE NOT MATCHING WITH ITEMS TOTAL !</center></div>");
                            }
                            else if(data.includes("Error4")){
                                 MessageManager.show("<div class='callout callout-danger'><center>FAILED : ADD ROW ITEMS TO THE GRN !</center></div>");
                                MessageManager1.show("<div class='callout callout-danger'><center>FAILED : ADD ROW ITEMS TO THE GRN !</center></div>");
                            }
          ...
          <div class="row">
            ...
            <div class="form-group">
                ...
                <option value=""> SELECT SUPPLIER </OPTION>
                      <?php
                                              $sql1 = mysqli_query($con,"SELECT id,company_name FROM supplier WHERE stat='1' AND company='$company' ORDER BY company_name  ASC");
                ...
                <input type="text" autocomplete="off" name="grnprice" class="form-control" id="grnprice" placeholder="Enter GRN Total Cost">
              </div>
            </div>
            <!-- /.col -->
            <div class="col-md-6">
              <div class="form-group">
                ...
                <div class="input-group date">
                  <div class="input-group-addon">
                    ...
                    <input autocomplete="off" data-date-format='yyyy-mm-dd' type="text" name="grndate" class="form-control pull-right" id="datepicker" required="">
                </div>  
              ...
              <div class="form-group">
                ...
                <input type="text" autocomplete="off" name="supplierinvoiceno" class="form-control" id="supplierinvoiceno" placeholder="Enter Supplier Invoice No">
              </div>
    ...
    <div class="table-repsonsive">
     ...
     <table class="table table-bordered" id="item_table">
      <tr>
       ...
       <div class='row'>
            <div class="col-md-6">
            <button type="submit" id="add_payment" class="btn btn-success" >Generate GRN</button>       												
       </div>
