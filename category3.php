...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
         ...
         $sql7 = "SELECT id FROM category_three WHERE company='$company' AND stat = '1' ";
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="text" autocomplete="off" name="cat3" class="form-control" id="cat3" placeholder="Enter Name for Category 03" required="">
              </div>
              <!-- /.form-group -->
         ...
         <div class="row">
          ...
          <div class="box-tools pull-right">
					...
					<th width='10%'><center> Actions</center></th>
                                                ...
                                                $id = 0;
                                                $name = "";
                                                $sql = "SELECT id,name FROM category_three WHERE stat = '1' AND company='$company' ORDER BY id ASC";
                                                        ...
                                                        $name = $arraySomething1['name'];
                                                         ...
                                                         echo "<tr><td align='left'>" . $name . " </td>";
                                                                   ...
                                                                   echo "<td align='center'>
                                                                                            ...
                                                                                            <a type='button' title='Click to Cancel the Name' class='btn btn-default btn-xs confirm_action' href='delete_cat3.php?id=".$id."'>
