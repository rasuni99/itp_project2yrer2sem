...
if (isset($_POST['invoiceno'])) {
    ...
    $invoice_id = 0;
    $sql1 = "SELECT id FROM invoice WHERE invoice_no='$invoice_no'";
...
<?php     
            ...
            echo '<table id="example1" class="table table-bordered ">';
                   ...
                   echo "<tr><th><center> Item </center></th><th><center> Description</center></th><th><center>Unit Price</center></th><th><center> Qty </center></th><th><center> Discounted Price</center></th><th><center> Sub Total</center></th>
                       ...
                       $sql = "SELECT item_id, item_name, description, quantity, unit_price,discount_per_item, min_sale_price, cash_price, credit_price FROM invoice_items WHERE invoice_id='$invoice_id' and stat='1'";
                            $result = mysqli_query($con, $sql);
                            while ($arraySomething1 = mysqli_fetch_array($result)) {
...
<?php 
            ...
            echo "Failed : Wrong Delivery Note NO. Check the Delivery Note No and Try again";  
        }
